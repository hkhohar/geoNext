...
export default function TermsConditions(){
    return (        
        <div className="flex flex-col gap-10">
            ...
            <p className="text-xl">Hyperlinking to our Content</p>
            <p>
